        ...
        <div class="col-lg-3 col-sm-6">
            ...
            <div class="clientssummarybox">
                ...
                <table class="clientssummarystats" cellspacing="0" cellpadding="2">
                    ...
                    <tr><td>{$_ADMINLANG.fields.phonenumber}</td><td><a href="https://wa.me/{$clientsdetails.phonenumber|strstr:'.':false|replace:'.':'+54'}" target="_blank">{$clientsdetails.phonenumber|strstr:'.':false|replace:'.':'+54'}</a></td></tr>
                    {if $showTaxIdField}
                        <tr class="altrow">
